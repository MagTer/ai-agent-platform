...
validates every push to `main`, branch patterns described in the [Delivery Model](../DELIVERY_MODEL.md#branches--labels), and all pull requests. All
...
The Codex PR template requires you to confirm each step from the
