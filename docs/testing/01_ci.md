...
Codex contributors should make sure every change satisfies the quality gates that CI
enforces. Follow these guidelines before opening a pull request:

- **Ruff** for linting (PEP8 + additional rules)
- **Black** for formatting (88-character lines)
- **mypy** for static typing (Python 3.11, strict mode)

### Required rules

- Fully type annotate every function.
- Remove unused imports or variables.
- Avoid redefining variables or functions.
