...
validates every push to `main`, `feature/*`, and `fix/*` branches and all pull requests; the
branch patterns mirror the conventions documented in [`docs/DELIVERY_MODEL.md`](../DELIVERY_MODEL.md).
All
