...
@app.command()
def up(detach: bool = typer.Option(True, help="Run services in the background.")) -> None:
...
@app.command()
def down(remove_volumes: bool = typer.Option(False, help="Remove persistent volumes.")) -> None:
