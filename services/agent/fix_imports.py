...
for f in files:
    ...
    new_txt = txt.replace(", List", "").replace("List, ", "").replace("from typing import List", "from typing import ")
    new_txt = new_txt.replace(", Dict", "").replace("Dict, ", "").replace("from typing import Dict", "from typing import ")
    new_txt = new_txt.replace(", Tuple", "").replace("Tuple, ", "").replace("from typing import Tuple", "from typing import ")
