...
async def admin_portal(admin: AdminUser = Depends(require_admin_or_redirect)) -> str:
    ...
    content = """
        <div style="text-align: center; margin-bottom: 32px;">
            <h1 style="margin: 0 0 8px 0; font-size: 28px; font-weight: 600;">Admin Portal</h1>
            <p style="margin: 0; color: var(--text-muted); font-size: 14px;">AI Agent Platform Administration</p>
        </div>
        ...
        <div class="grid">
            <a href="/platformadmin/diagnostics/" class="portal-card">
        ...
        <div class="grid">
            <a href="/platformadmin/users/" class="portal-card">
                <div class="card-icon blue">&#128100;</div>
                <h2>Users</h2>
        ...
        <div class="grid">
            <a href="/platformadmin/price-tracker/" class="portal-card">
                <div class="card-icon green">&#128181;</div>
                <h2>Price Tracker</h2>
                <p>Manage product price tracking, store links, deals monitoring, and price alerts.</p>
            </a>

            <a href="/platformadmin/mcp/" class="portal-card">
                <div class="card-icon purple">&#128268;</div>
                <h2>MCP Servers</h2>
...
# Remove the old template function
def _get_admin_portal_template() -> str:
    """Return the admin portal HTML template (deprecated - kept for backwards compatibility)."""
    return """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
