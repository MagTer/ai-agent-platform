...
model: haiku
color: orange
allowedTools: ["Bash(git status:*)", "Bash(git add:*)", "Bash(git commit:*)", "Bash(git push:*)", "Bash(git pull:*)", "Bash(git fetch:*)", "Bash(git checkout:*)", "Bash(git rebase:*)", "Bash(git merge:*)", "Bash(git branch:*)", "Bash(git log:*)", "Bash(git diff:*)", "Bash(git restore:*)", "Bash(git cherry-pick:*)", "Bash(git -C:*)", "Bash(gh pr create:*)", "Bash(gh pr merge:*)", "Bash(gh pr list:*)", "Bash(gh pr view:*)", "Bash(gh pr checks:*)", "Bash(gh pr edit:*)", "Bash(gh pr close:*)", "Bash(gh run view:*)", "Bash(gh run watch:*)", "Bash(gh api:*)", "Bash(./stack:*)", "Bash(./stack check:*)", "Bash(./stack dev:*)", "Bash(./stack deploy:*)", "Bash(./stack test:*)", "Bash(./stack lint:*)", "Bash(docker exec:*)", "Bash(docker ps:*)", "Bash(docker logs:*)", "Bash(docker compose:*)", "Bash(docker-compose:*)", "Bash(docker restart:*)", "Bash(docker stop:*)", "Bash(docker start:*)", "Bash(docker stats:*)", "Bash(docker rm:*)", "Bash(docker run:*)", "Bash(docker images:*)", "Bash(docker inspect:*)", "Bash(docker volume:*)", "Bash(docker network:*)", "Bash(docker cp:*)", "Bash(curl:*)", "Bash(cat:*)", "Bash(echo:*)", "Bash(printf:*)", "Bash(sqlite3:*)", "Bash(ls:*)", "Bash(find:*)", "Bash(grep:*)", "Bash(wc:*)", "Bash(head:*)", "Bash(sort:*)", "Bash(xargs:*)", "Bash(tree:*)", "Bash(python3:*)", "Bash(openssl rand:*)", "Bash(dig:*)", "Bash(poetry run:*)", "Bash(poetry show:*)", "Bash(pip-audit:*)", "Read", "Write"]
---
